...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--file_path",
        type=str,
        help="Path to the DROP dataset (JSON file) you'd like to annotate (either the train or dev set).",
    )
    ...
    test = annotate_text(sNLP, text)
    
    # step 2: read in original DROP dataset
    with open(args.file_path) as dataset_file:
